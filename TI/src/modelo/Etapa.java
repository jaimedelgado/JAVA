...
public class Etapa {
	...
	public Etapa(Exp exp, Recurso rec, Continuacion[] array, int num, String h){
		this.recurso=rec;
		this.continuaciones=array;
		this.numContinuaciones=num;
		this.html = h;
	}
	public Etapa(Exp exp, Etapa e){
		this.recurso=e.recurso();
		this.continuaciones=e.continuaciones();
		this.numContinuaciones=e.numContinuaciones();
		this.html=e.html();
	}
	//Metodos
	/**
	...
	/**
	 * Devuelve una continuacion con su texto y su Etapa
