...
import visitas.diagram.edit.policies.VisitasTextSelectionEditPolicy;
import visitas.diagram.part.VisitasVisualIDRegistry;
import visitas.diagram.providers.VisitasElementTypes;
import visitas.diagram.providers.VisitasParserProvider;

/**
 * @generated
 */
public class ContinuacionTextoContinuacionEditPart extends CompartmentEditPart
	 ...
	 * @generated
	 */
	public ContinuacionTextoContinuacionEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new VisitasTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return VisitasElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = VisitasParserProvider
					.getParser(
							VisitasElementTypes.Continuacion_2003,
							getParserElement(),
							VisitasVisualIDRegistry
									.getType(visitas.diagram.edit.parts.ContinuacionTextoContinuacionEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null,
					VisitasEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
