 ...
 * @generated
 */
public class RecursoHtmlRecursoEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public RecursoHtmlRecursoEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = VisitasParserProvider
					.getParser(
							VisitasElementTypes.Recurso_2001,
							getParserElement(),
							VisitasVisualIDRegistry
									.getType(visitas.diagram.edit.parts.RecursoHtmlRecursoEditPart.VISUAL_ID));
		}
		return parser;
	}
