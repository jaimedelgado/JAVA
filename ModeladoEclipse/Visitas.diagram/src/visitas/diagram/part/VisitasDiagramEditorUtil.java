 ...
 * @generated
 */
public class VisitasDiagramEditorUtil {
	...
	public static Resource openModel(Shell shell, String description,
		...
		try {
			...
			MessageDialog
					.openError(
							shell,
							Messages.VisitasDiagramEditorUtil_OpenModelResourceErrorDialogTitle,
							NLS.bind(
									Messages.VisitasDiagramEditorUtil_OpenModelResourceErrorDialogMessage,
									fileName));
		}
		return resource;
	}
	...
	public static void runWizard(Shell shell, Wizard wizard, String settingsKey) {
		IDialogSettings pluginDialogSettings = VisitasDiagramEditorPlugin
	...
	public static Resource createDiagram(URI diagramURI, URI modelURI,
		...
		progressMonitor.beginTask(
				Messages.VisitasDiagramEditorUtil_CreateDiagramProgressTask, 3);
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
				editingDomain,
				Messages.VisitasDiagramEditorUtil_CreateDiagramCommandLabel,
				Collections.EMPTY_LIST) {
			protected CommandResult doExecuteWithResult(
					IProgressMonitor monitor, IAdaptable info)
					throws ExecutionException {
				Visita model = createInitialModel();
				attachModelToResource(model, modelResource);

				Diagram diagram = ViewService.createDiagram(model,
						VisitaEditPart.MODEL_ID,
						VisitasDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
				if (diagram != null) {
				...
				try {
					modelResource
							.save(visitas.diagram.part.VisitasDiagramEditorUtil
									.getSaveOptions());
					diagramResource
							.save(visitas.diagram.part.VisitasDiagramEditorUtil
									.getSaveOptions());
	 ...
	 * @generated
	 */
	private static Visita createInitialModel() {
		return VisitasFactory.eINSTANCE.createVisita();
	}
	 ...
	 * @generated
	 */
	private static void attachModelToResource(Visita model, Resource resource) {
