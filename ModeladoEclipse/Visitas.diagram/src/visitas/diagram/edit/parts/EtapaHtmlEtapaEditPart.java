 ...
 * @generated
 */
public class EtapaHtmlEtapaEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EtapaHtmlEtapaEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = VisitasParserProvider
					.getParser(
							VisitasElementTypes.Etapa_2002,
							getParserElement(),
							VisitasVisualIDRegistry
									.getType(visitas.diagram.edit.parts.EtapaHtmlEtapaEditPart.VISUAL_ID));
		}
		return parser;
	}
